module.exports = async function getTitle(pageURL, verbose = false) {
    ...
    await axios.get(pageURL).then(res =>{
        ...
        ficInfo.wordCount = getElementsBy($, 'dl[class="stats"]', 'dd[class="words"]', verbose)[0];
        ficInfo.commentCount = getElementsBy($, 'dl[class="stats"]', 'dd[class="comments"]', verbose)[0]
        ficInfo.kudosCount = getElementsBy($, 'dl[class="stats"]', 'dd[class="kudos"]', verbose)[0]
